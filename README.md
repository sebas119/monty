...
```
$ git clone https://github.com/sebaslherrera/monty
```
...
```
$ cat bytecodes/push_print.m
push 1
push 2
push 3
pall
pint
$ ./monty bytecodes/push_print.m
3
2
1
3
...
mul
pall
$ ./monty bytecodes/arithmetic_op.m
1
2
3
2
